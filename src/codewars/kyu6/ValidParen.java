...
public class ValidParen {
  ...
  public static void main(String[] args) {
    System.out.println(validParentheses("c}(C(F)M(4f8Zs)-CX)"));
    System.out.println(validParenthesesV2("c}(C(F)M(4f8Zs)-CX)"));
    System.out.println(validParenthesesV3("c}(C(F)M(4f8Zs)-CX)"));
  }
