...
public class MyArrays {
  ...
  public static void main(String[] args) {
    int[][] arr = new int[][]{
            ...
            {4, 5, 6},
            {7, 8, 9}};
    System.out.println(java.util.Arrays.deepToString(rotateLeft(arr)));
    System.out.println(java.util.Arrays.deepToString(rotateLeftAndSwitchRows(arr)));

    System.out.println(java.util.Arrays.deepToString(rotateRight(arr)));
